...
echo''.tampilbaris($alternatif).'<hr>';	

echo'<h4>Nilai Kepentingan Alternatif (Bentuk Desimal)</h4>';
...
echo'<h4>Jumlah Baris Nilai Kepentingan alternatif</h4>';
echo''.tampilbaris($jk).'<hr>';

echo'<h4>Nilai Kepentingan/ Jumlah Baris Nilai Kepentingan alternatif</h4>';
echo''.tampiltabel($nk).'<hr>';

echo'<h4>Jumlah Kolom (Nilai Kepentingan/ Jumlah Baris Nilai Kepentingan alternatif)</h4>';
...
echo'<h4>Nilai Eigen (Bobot alternatif)</h4>';
