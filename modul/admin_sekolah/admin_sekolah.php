...
switch ($modul) {
	case "tampil":
	$sql_tampil = "select a.*, b.* from admin_sekolah a, sekolah b where a.id_sekolah = b.id_sekolah";
				...
				<div class="box-body">
					<table class="table table-bordered table-striped">
						...
						<div class="form-group">
							...
							<td>
								<select class="form-control progress horizontal" name="id_sekolah" required/>
									<option selected value="">-- Silahkan Pilih --</option>';
									$sekolah = mysql_query("select * from sekolah order by id_sekolah");
									while ($data_sekolah=mysql_fetch_array($sekolah)) {
	...
	case "edit":
	$sql_cek = "select a.*, b.* from admin_sekolah a, sekolah b where a.id_sekolah = b.id_sekolah and a.nip = '$_GET[nip]'";
				...
				<div class="box-body">
					<table class="table table-bordered table-striped">
						...
						<div class="form-group">
							...
							<td>
								<select class="form-control progress horizontal" name="id_sekolah" required/>
									<option selected value="'.$data['id_sekolah'].'">'.$data['nama_sekolah'].'</option>';
									$sekolah = mysql_query("select * from sekolah order by id_sekolah");
									while ($data_sekolah=mysql_fetch_array($sekolah)) {
										echo'<option value="'.$data_sekolah['id_sekolah'].'">'.$data_sekolah['nama_sekolah'].'</option>';
									}
